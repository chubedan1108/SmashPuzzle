Shader "TextMeshPro/Distance Field With Shine" {
	Properties {
		...
		_ShineTrigger ("Shine Trigger", Range(0, 1)) = 0
		_ActivationTime ("Activation Time", Float) = 0
		_ShineInterval ("Shine Interval", Float) = 2
		_ShineDuration ("Shine Duration", Float) = 1.1
		_ShineWidth ("Shine Width", Range(0, 1)) = 0.1
		_ShineMargin ("Shine Margin", Range(0, 1)) = 0.1
		_ShineStrength ("Shine Strength", Float) = 1
		_ShineDirection ("Shine Direction", Vector) = (0.3,-0.5,0,0)
		_ShineStart ("Shine Start (auto)", Float) = 0
		_ShineEnd ("Shine End (auto)", Float) = 1
	}
