Shader "Cypher/2D/Default" {
	Properties {
		_MainTex ("Main Texture", 2D) = "white" {}
		[ColorUsage(true, true)] [HDR] _Color ("Tint", Vector) = (1,1,1,1)
		_AlphaMultiplier ("Alpha Multiplier", Range(0, 32)) = 1
